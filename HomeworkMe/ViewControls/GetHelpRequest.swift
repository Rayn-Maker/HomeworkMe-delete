...
class GetHelpRequest: UIView, MFMessageComposeViewControllerDelegate, UNUserNotificationCenterDelegate {
...
extension GetHelpRequest: UITableViewDelegate, UITableViewDataSource {
